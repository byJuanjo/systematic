...
function crearInf(){
  ...
  $.ajax({
    ...
    success: function(data){
      if(data.mensaje=='1'){
        $.get('valores.descripcion',function(data){
...
function editar_valores(inf_id){
  $.get('valores/'+inf_id,function(data){
...
function eliminar_valores(infs){
  var n = noty({
