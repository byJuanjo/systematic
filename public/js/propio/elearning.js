...
function crearInf(){
  ...
  $.ajax({
    ...
    success: function(data){
      if(data.mensaje=='1'){
        $.get('elearning.descripcion',function(data){
...
function editar_elearning(inf_id){
  $.get('elearning/'+inf_id,function(data){
...
function eliminar_elearning(infs){
  var n = noty({
