<form class="" id="frEditHor" method="post">
  <div class="form-group">
    <label for="laboratiorios_id" class="col-md-2 control-label"><strong>Laboratorio</strong></label>
    <div class="col-md-6">
      <input type="hidden" readonly id="horario_id" name="horario_id" value="{{$horario->id}}">
      <select class="form-control required" name="laboratorios_id" id="laboratorios_id" onchange="vacantesSel(this,'frEditHor')">
  ...
  <div class="form-group">
    ...
    <div class="col-md-3">
      <input type=date name="fecha_inicio" id="fecha_inicio" class="form-control required" value="{{$horario->fecha_inicio}}">
    </div>
    <label for="fecha_inicio" class="col-md-2 control-label"><strong>Fecha Fin</strong></label>
    <div class="col-md-3">
      <select class="form-control required" id="fecha_fin" name="fecha_fin">
        <option <?php if($horario->fecha_fin=='4 SEMANAS'){ ?> selected <?php } ?> value="4 SEMANAS">4 SEMANAS</option>
        <option <?php if($horario->fecha_fin=='6 SEMANAS'){ ?> selected <?php } ?> value="6 SEMANAS">6 SEMANAS</option>
      </select>
    </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-md-3">
      <input type=date name="fecha_muestra" id="fecha_muestra" class="form-control required" value="{{$horario->fecha_muestra}}">
    </div>
    <label for="fecha_inicio" class="col-md-2 control-label"><strong>Fecha Fin Pub.</strong></label>
    <div class="col-md-3">
      <input type=date name="fecha_finmuestra" id="fecha_finmuestra" class="form-control required" value="{{$horario->fecha_finmuestra}}">
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    <button type="button" class="btn btn-success" onclick="editar_horario()">Actualizar</button>
  </div>
</form>
