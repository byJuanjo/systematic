  ...
  <div class="col-md-4">
    <div class="box well">
      <div class="box-body box-profile">
        ...
        <?php } ?>
        <h3 class="profile-username text-center">{{$user->razon_social}}</h3>
        <p class="text-muted text-center">{{$user->name_tipo}}</p>
        <ul class="list-group list-group-unbordered">
          <li class="list-group-item">
            <b>RUC</b> <a class="pull-right">{{$user->documento}}</a>
          </li>
          <li class="list-group-item">
      ...
      <div class="box-body box-profile">
        <form class="" id="formProfile" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control required" name="razon_social" id="razon_social" value="{{$user->razon_social}}">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control required" name="direccion" id="direccion" value="{{$user->direccion}}">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label for="apellido">Apellidos Administrador</label>
