<form class="" id="frInfe" method="post">
  ...
  <div class="form-group">
    <label for=""><strong>Titulo de la sección:</strong></label>
      <input type="hidden" readonly="true" name="id" id="id" size="50" class="required" value="{{$valor->id}}" />
    <input type="text" name="titulo" id="titulo" size="50" class="required" value="{{$valor->titulo}}" />
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <textarea class="ckeditor" name="html" id="html" rows="10"  class="required" cols="80">{{$valor->html}}</textarea>
  </div>
</form>
<br>
